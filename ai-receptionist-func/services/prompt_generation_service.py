...
def build_openai_prompt_request(
    *,
    ...
    developer_rules = (
        ...
        "- Make the prompt specific to this business; avoid generic placeholders.\n"
        "- Use the provided business profile and knowledge text as ground truth.\n"
        "- Mention services, location/service area, hours/openings, and contact details when provided.\n"
        "- Do not invent facts; if details are missing, instruct the agent to ask or take a message.\n"
    ...
    user_content = (
        ...
        "Business profile JSON (authoritative; use these facts explicitly):\n"
        f"{profile_json}\n\n"
        "Knowledge text (crawl/manual content; use for extra details):\n"
        f"{knowledge_text}\n\n"
        f"{example_flows}"
    )
